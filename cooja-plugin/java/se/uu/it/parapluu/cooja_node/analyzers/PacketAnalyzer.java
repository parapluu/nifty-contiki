...
public abstract class PacketAnalyzer {
  ...
  public abstract int analyzePacket(Packet packet, LinkedList<OtpErlangObject> analysis);
  
  public static OtpErlangTuple make_opt(String key, OtpErlangObject value) {
	  OtpErlangObject content[] = new OtpErlangObject[2];
	  content[0] = new OtpErlangAtom(key);
	  content[1] = value;
	  return new OtpErlangTuple(content);
  }
}
